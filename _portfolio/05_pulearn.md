...
#### :abacus: **理論計算手法**
- [**Gaussian**](https://gaussian.com): 量子化学計算
...
1. Substrate Scope Metrics  
   ...
   [![](https://img.shields.io/badge/GitHub-streamlit--substrate--scope--metrics-brightgreen?logo=github)](https://github.com/poclab-web/streamlit-substrate-scope-metrics)
...
#### **様々な反応系への応用**
- 教科書に載っている人名反応をはじめとする、様々な反応へ応用していく。

#### **三次元グリッド記述子の活用**
- 当研究室で[実績](https://poclab-web.github.io/homepage/portfolio/04_ketone_reduction_TS_ML/)のある[eCoMFA](https://github.com/poclab-web/eCoMFA)を用いて、分子の電子状態から反応の特徴を紐解いていく。

#### **分子特性予測と反応性予測の融合**
- 有用な特性を持つ分子の予測とそれらの合成可能性の予測を組み合わせ、さらに効率的な実験が可能になる。

#### **PNU learning を用いた機械学習モデルの構築**
- 負例(Negative)データも活用した反応予測法の開発、より明確な基質適用範囲の予測が期待される。
